        ...
        <div className="flex flex-col md:flex-row   justify-between py-3 md:py-0 md:px-[15px]">
            ...
            <div className="flex justify-center">
                {quickLinks.map((menu, index) => (
                    <span
                        key={index}
                        className="text-[#70757a] text-[12px] md:text-[14px] leading-none cursor-pointer p-[10 md:p-[15px]">
                   {menu}
                </span>))}
            </div>
            <div className="flex justify-center">
                {settingMenu.map((menu, index) => (
                    <span
                        key={index}
                        className="text-[#70757a] text-[12px] md:text-[14px] cursor-pointer leading-none p-[10 md:p-[15px]">
                   {menu}
                </span>))}
            </div>
